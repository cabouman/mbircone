function [ dataSetInfo ] = readDataSetPath_LillyNSI( masterFile, plainParamsFile )
...
relpath.nsipro_filePath = plainParams(executablePath, get_set, masterFile, masterField, 'nsipro_filePath', value, resolveFlag) ;
...
dataSetInfo.nsipro_filePath = getAbsPath_withNull(dataSetInfo.main_folderPath, relpath.nsipro_filePath);
