...
folderName_binary = '/Volumes/Data/Cone_beam_results/RenderResults';
...
opts.mode = 'absolute 0 0.035';
opts.mode = 'absolute 0 0.05';
opts.mode = 'absolute 0 0.1';
% opts.mode = 'absolute 0.05 0.12';
% opts.mode = 'absolute 3 8';
% opts.mode = 'absolute 0 1';
% opts.mode = 'absolute 0 2.5';
% opts.mode = 'absolute 1.9 2.5';
% opts.mode = 'absolute 0 60';
% opts.mode = 'absolute 4 9';
% opts.mode = 'absolute -0.5 0.5';
% opts.mode = 'absolute 0 0.6';
opts.mode = 'percentile 1 99';
% opts.mode = 'percentile 0 100';
% opts.mode = 'absolute 0.2 1';
